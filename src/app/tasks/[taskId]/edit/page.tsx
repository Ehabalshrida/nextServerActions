...
const EditTaskPage = async ({ params }: EditTaskPageProps) => {
    ...
    const task = await prisma.task.findUnique({
        where: { id: parseInt(resolvedParams.taskId) }
    });
    ...
    return (
        <section>
            <Link className="underline block mb-10" href={`/tasks/${task.id}`}>
            ...
            <div className="w-2/3 mx-auto rounded-md p-5 bg-slate-800 border-2 border-gray-300">
                ...
                <form action={updateTask} className="flex flex-col gap-6">
                    ...
                    <input
                        ...
                        name="title"
                        className="p-2 bg-white text-xl rounded-md text-gray-950"
                    ...
                    <textarea
                        ...
                        className="p-2 bg-white text-xl rounded-md text-gray-950 resize-none"
                    ></textarea>
                    <button
                        type="submit"
