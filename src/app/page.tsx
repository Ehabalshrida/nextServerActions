...
// use to convert the page to dynamic page, server render it on demands, not on the build time as static pages
// export const dynamic = "force-dynamic";
// Revalidate the page every 10 seconds to keep the data fresh using Incremental Static Regeneration (ISR), but page still static page
